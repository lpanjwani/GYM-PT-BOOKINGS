...
public abstract class ClientView extends VBox {
        ...
        protected final Button currentDisconnect;
        protected final Button currentConnect;
        ...
        protected final ChoiceBox createStartMinutes;
        protected final ChoiceBox createStartHours;
        protected final ChoiceBox createEndMinutes;
        protected final ChoiceBox createEndHours;
        ...
        public ClientView() {
                ...
                currentDisconnect = new Button();
                currentConnect = new Button();
                ...
                createStartMinutes = new ChoiceBox();
                createStartHours = new ChoiceBox();
                createEndMinutes = new ChoiceBox();
                createEndHours = new ChoiceBox();
                ...
                currentDisconnect.setAlignment(javafx.geometry.Pos.CENTER);
                currentDisconnect.setDefaultButton(true);
                currentDisconnect.setLayoutX(294.0);
                currentDisconnect.setLayoutY(15.0);
                currentDisconnect.setMnemonicParsing(false);
                currentDisconnect.setStyle("-fx-background-color: #ff4d4d;");
                currentDisconnect.setText("Disconnect");
                currentDisconnect.setCursor(Cursor.DEFAULT);

                currentConnect.setAlignment(javafx.geometry.Pos.CENTER);
                currentConnect.setDefaultButton(true);
                currentConnect.setLayoutX(219.0);
                currentConnect.setLayoutY(15.0);
                currentConnect.setMnemonicParsing(false);
                currentConnect.setStyle("-fx-background-color: #4ff4a2;");
                currentConnect.setText("Connect");
                currentConnect.setCursor(Cursor.DEFAULT);
                ...
                createFocusLabel.setText("Focus ID: ");
                ...
                createDeleteButton.setLayoutX(195.0);
                ...
                createUpdateButton.setLayoutX(19.0);
                ...
                createPTSelect.setPrefWidth(239.0);

                createClientSelect.setLayoutX(107.0);
                createClientSelect.setLayoutY(163.0);
                createClientSelect.setPrefHeight(31.0);
                createClientSelect.setPrefWidth(239.0);

                createStartMinutes.setLayoutX(229.0);
                createStartMinutes.setLayoutY(351.0);
                createStartMinutes.setPrefHeight(31.0);
                createStartMinutes.setPrefWidth(112.0);
                createStartMinutes.setOpaqueInsets(new Insets(0.0));

                createStartHours.setLayoutX(109.0);
                createStartHours.setLayoutY(351.0);
                createStartHours.setPrefHeight(31.0);
                createStartHours.setPrefWidth(112.0);
                createStartHours.setOpaqueInsets(new Insets(0.0));

                createEndMinutes.setLayoutX(230.0);
                createEndMinutes.setLayoutY(414.0);
                createEndMinutes.setPrefHeight(31.0);
                createEndMinutes.setPrefWidth(112.0);
                createEndMinutes.setOpaqueInsets(new Insets(0.0));

                createEndHours.setLayoutX(110.0);
                createEndHours.setLayoutY(414.0);
                createEndHours.setPrefHeight(31.0);
                createEndHours.setPrefWidth(112.0);
                createEndHours.setOpaqueInsets(new Insets(0.0));
                ...
                currentAnchorPane.getChildren().add(currentDisconnect);
                currentAnchorPane.getChildren().add(currentConnect);
                ...
                createAnchorPane.getChildren().add(createStartMinutes);
                createAnchorPane.getChildren().add(createStartHours);
                createAnchorPane.getChildren().add(createEndMinutes);
                createAnchorPane.getChildren().add(createEndHours);
